 ...
 */
 ...
 ! function(t, e) {
     ...
     const t = t => {
         ...
         a = (t, e, n) => {
             Object.keys(n).forEach(r => {
                 ...
                 var l;
                 if (!new RegExp(i).test(o)) throw new TypeError(`${t.toUpperCase()}: Option "${r}" provided type "${o}" but expected type "${i}".`)
             })
         },
         ...
         v = (t, e, n = !0) => {
             ...
             const a = ({
                 ...
                 n === e && (i = !0, e.removeEventListener("transitionend", a), g(t))
             };
     ...
     function A(t, e, n, r, s) {
         ...
         if (n || (n = r, r = null), E.test(e)) {
             const t = t => function(e) {
                 if (!e.relatedTarget || e.relatedTarget !== e.delegateTarget && !e.delegateTarget.contains(e.relatedTarget)) return t.call(this, e)
             };
             r ? r = t(r) : n = t(n)
         }
         const [i, a, o] = M(e, n, r), l = P(t), c = l[o] || (l[o] = {}), u = O(c, a, i ? n : null);
                 ...
                 return function r(s) {
                     ...
                     for (let {
                         ...
                         for (let o = i.length; o--;)
                             if (i[o] === a) return s.delegateTarget = a, r.oneOff && D.off(t, s.type, e, n), n.apply(a, [s]);
                     return null
                 }
             }(t, n, r) : function(t, e) {
                 return function n(r) {
                     return r.delegateTarget = t, n.oneOff && D.off(t, r.type, e), e.apply(t, [r])
                 }
             }(t, n);
     ...
     const D = {
             ...
             off(t, e, n, r) {
                 if ("string" != typeof e || !t) return;
                 const [s, i, a] = M(e, n, r), o = a !== e, l = P(t), c = e.startsWith(".");
                 if (void 0 !== i) {
                     if (!l || !l[a]) return;
     ...
     class $ {
         constructor(t) {
             (t = i(t)) && (this._element = t, V.set(this._element, this.constructor.DATA_KEY, this))
         }
         dispose() {
             V.remove(this._element, this.constructor.DATA_KEY), D.off(this._element, this.constructor.EVENT_KEY), Object.getOwnPropertyNames(this).forEach(t => {
                 this[t] = null
             })
         }
     ...
     const N = (t, e = "hide") => {
         ...
         D.on(document, r, `[data-bs-dismiss="${s}"]`, (function(r) {
             if (["A", "AREA"].includes(this.tagName) && r.preventDefault(), l(this)) return;
     ...
     const B = {
             ...
             getDataAttributes(t) {
                 ...
                 return Object.keys(t.dataset).filter(t => t.startsWith("bs")).forEach(n => {
                     let r = n.replace(/^bs/, "");
                     r = r.charAt(0).toLowerCase() + r.slice(1, r.length), e[r] = z(t.dataset[n])
                 }), e
             },
     ...
     class J extends $ {
         ...
         pause(t) {
             t || (this._isPaused = !0), F.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (r(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
         }
         cycle(t) {
         ...
         to(t) {
             ...
             if (this._isSliding) return void D.one(this._element, "slid.bs.carousel", () => this.to(t));
         ...
         _handleSwipe() {
             ...
             this.touchDeltaX = 0, e && this._slide(e > 0 ? K : X)
         }
         _addEventListeners() {
             this._config.keyboard && D.on(this._element, "keydown.bs.carousel", t => this._keydown(t)), "hover" === this._config.pause && (D.on(this._element, "mouseenter.bs.carousel", t => this.pause(t)), D.on(this._element, "mouseleave.bs.carousel", t => this.cycle(t))), this._config.touch && this._touchSupported && this._addTouchEventListeners()
         }
         _addTouchEventListeners() {
             ...
             }), this._pointerEvent ? (D.on(this._element, "pointerdown.bs.carousel", e => t(e)), D.on(this._element, "pointerup.bs.carousel", t => n(t)), this._element.classList.add("pointer-event")) : (D.on(this._element, "touchstart.bs.carousel", e => t(e)), D.on(this._element, "touchmove.bs.carousel", t => e(t)), D.on(this._element, "touchend.bs.carousel", t => n(t)))
         }
         _keydown(t) {
         ...
         _slide(t, e) {
             ...
             if (this._element.classList.contains("slide")) {
                 i.classList.add(u), p(i), r.classList.add(c), i.classList.add(c);
                 const t = () => {
                     i.classList.remove(c, u), i.classList.add("active"), r.classList.remove("active", u, c), this._isSliding = !1, setTimeout(h, 0)
                 };
                 this._queueCallback(t, r, !0)
             } else r.classList.remove("active"), i.classList.add("active"), this._isSliding = !1, h();
             o && this.cycle()
         }
         _directionToOrder(t) {
         ...
         static dataApiClickHandler(t) {
             ...
             const r = { ...B.getDataAttributes(e),
                     ...B.getDataAttributes(this)
                 },
                 s = this.getAttribute("data-bs-slide-to");
             s && (r.interval = !1), J.carouselInterface(e, r), s && J.getInstance(e).to(s), t.preventDefault()
         }
     }
     D.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", J.dataApiClickHandler), D.on(window, "load.bs.carousel.data-api", () => {
         ...
         for (let e = 0, n = t.length; e < n; e++) J.carouselInterface(t[e], J.getInstance(t[e]))
     }), m(J);
     const Z = {
             toggle: !0,
             parent: null
     ...
     class et extends $ {
         constructor(t, n) {
             ...
             for (let t = 0, n = r.length; t < n; t++) {
                 ...
                 null !== s && i.length && (this._selector = s, this._triggerArray.push(n))
             }
         ...
         show() {
             ...
             e.forEach(e => {
                 n !== e && et.getOrCreateInstance(e, {
                     toggle: !1
                 }).hide(), t || V.set(e, "bs.collapse", null)
             });
             ...
             this._queueCallback(() => {
                 this._isTransitioning = !1, this._element.classList.remove("collapsing"), this._element.classList.add("collapse", "show"), this._element.style[r] = "", D.trigger(this._element, "shown.bs.collapse")
         ...
         _getConfig(t) {
             return (t = { ...Z,
                 ...B.getDataAttributes(this._element),
                 ...t
             }).toggle = Boolean(t.toggle), t.parent = i(t.parent), a("collapse", t, tt), t
         }
         _getDimension() {
         ...
         fn: function(t) {
             ...
             Object.keys(e.elements).forEach((function(t) {
                 var n = e.styles[t] || {},
                     r = e.attributes[t] || {},
                     s = e.elements[t];
                 ht(s) && ut(s) && (Object.assign(s.style, n), Object.keys(r).forEach((function(t) {
                     var e = r[t];
             ...
             return Object.assign(e.elements.popper.style, n.popper), e.styles = n, e.elements.arrow && Object.assign(e.elements.arrow.style, n.arrow),
                 function() {
                     Object.keys(e.elements).forEach((function(t) {
                         ...
                         ht(r) && ut(r) && (Object.assign(r.style, i), Object.keys(s).forEach((function(t) {
                             r.removeAttribute(t)
                         })))
                     }))
                 }
     ...
     function yt(t, e) {
         ...
         var n = t.getBoundingClientRect(),
             r = 1,
             s = 1;
         return ht(t) && e && (r = n.width / t.offsetWidth || 1, s = n.height / t.offsetHeight || 1), {
             width: vt(n.width / r),
     ...
     function kt(t) {
         for (var e = pt(t), n = Et(t); n && St(n) && "static" === wt(n).position;) n = Et(n);
         return n && ("html" === ut(n) || "body" === ut(n) && "static" === wt(n).position) ? e : n || function(t) {
             var e = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox");
             if (-1 !== navigator.userAgent.indexOf("Trident") && ht(t) && "fixed" === wt(t).position) return null;
     ...
     var Dt = {
             ...
             fn: function(t) {
                 var e, n = t.state,
                     ...
                     o = gt(n.placement),
                     l = Tt(o),
                     c = [it, st].indexOf(o) >= 0 ? "height" : "width";
                 if (i && a) {
                     var u = function(t, e) {
     ...
     function Vt(t) {
         ...
         if (l) {
             var _ = kt(n),
                 w = "clientHeight",
                 S = "clientWidth";
             _ === pt(n) && "static" !== wt(_ = Ct(n)).position && (w = "scrollHeight", S = "scrollWidth"), _ = _, s === nt && (y = rt, f -= _[w] - r.height, f *= o ? 1 : -1), s === it && (v = st, d -= _[S] - r.width, d *= o ? 1 : -1)
         }
         var C, x = Object.assign({
             position: a
         }, l && Lt);
         return o ? Object.assign({}, x, ((C = {})[y] = g ? "0" : "", C[v] = m ? "0" : "", C.transform = (b.devicePixelRatio || 1) < 2 ? "translate(" + d + "px, " + f + "px)" : "translate3d(" + d + "px, " + f + "px, 0)", C)) : Object.assign({}, x, ((e = {})[y] = g ? f + "px" : "", e[v] = m ? d + "px" : "", e.transform = "", e))
     }
     var $t = {
             name: "computeStyles",
             enabled: !0,
     ...
     function Xt(t, e) {
         return "viewport" === e ? Yt(function(t) {
             ...
             var e, n = Ct(t),
                 ...
                 i = Pt(n.scrollWidth, n.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0),
                 a = Pt(n.scrollHeight, n.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0),
                 o = -r.scrollLeft + Wt(t),
                 l = -r.scrollTop;
             ...
             _ = function(t, e, n) {
                 var r = "clippingParents" === e ? function(t) {
                     ...
                     a = s.reduce((function(e, n) {
                         var r = Xt(t, n);
                         return e.top = Pt(r.top, e.top), e.right = Ot(r.right, e.right), e.bottom = Ot(r.bottom, e.bottom), e.left = Pt(r.left, e.left), e
                     }), Xt(t, i));
                     ...
                     a = lt.reduce((function(t, n) {
                         return t[n] = function(t, e, n) {
                             var r = gt(t),
                                 ...
                                 a = i[0],
                                 o = i[1];
                             return a = a || 0, o = (o || 0) * s, [it, st].indexOf(r) >= 0 ? {
                                 x: o,
                                 y: a
                             } : {
                                 x: a,
     ...
     function ae(t, e, n) {
         ...
         } : Ft(r)), ht(e) ? ((u = yt(e, !0)).x += e.clientLeft, u.y += e.clientTop) : o && (u.x = Wt(o))), {
             ...
             var s, a, o = {
                 ...
                 u = {
                     ...
                     setOptions: function(n) {
                         ...
                         }((s = [].concat(r, o.options.modifiers), a = s.reduce((function(t, e) {
                             var n = t[e.name];
     ...
     class Ce extends $ {
         ...
         _completeHide(t) {
             D.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented || ("ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach(t => D.off(t, "mouseover", u)), this._popper && this._popper.destroy(), this._menu.classList.remove("show"), this._element.classList.remove("show"), this._element.setAttribute("aria-expanded", "false"), B.removeDataAttribute(this._menu, "popper"), D.trigger(this._element, "hidden.bs.dropdown", t))
         }
         _getConfig(t) {
             if (t = { ...this.constructor.Default,
                     ...B.getDataAttributes(this._element),
                     ...t
                 }, a("dropdown", t, this.constructor.DefaultType), "object" == typeof t.reference && !s(t.reference) && "function" != typeof t.reference.getBoundingClientRect) throw new TypeError("dropdown".toUpperCase() + ': Option "reference" provided type "object" without a required "getBoundingClientRect" method.');
             return t
         }
         _createPopper(t) {
             ...
             this._popper = de(e, this._menu, n), r && B.setDataAttribute(this._menu, "popper", "static")
         }
         _isShown(t = this._element) {
             return t.classList.contains("show")
         }
         ...
         static dataApiKeydownHandler(t) {
             if (/input|textarea/i.test(t.target.tagName) ? "Space" === t.key || "Escape" !== t.key && ("ArrowDown" !== t.key && "ArrowUp" !== t.key || t.target.closest(".dropdown-menu")) : !fe.test(t.key)) return;
             ...
             if ("Escape" !== t.key) return "ArrowUp" === t.key || "ArrowDown" === t.key ? (e || r.show(), void r._selectMenuItem(t)) : void(e && "Space" !== t.key || Ce.clearMenus());
             r.hide()
         }
     }
     D.on(document, "keydown.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', Ce.dataApiKeydownHandler), D.on(document, "keydown.bs.dropdown.data-api", ".dropdown-menu", Ce.dataApiKeydownHandler), D.on(document, "click.bs.dropdown.data-api", Ce.clearMenus), D.on(document, "keyup.bs.dropdown.data-api", Ce.clearMenus), D.on(document, "click.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', (function(t) {
     ...
     class xe {
         ...
         _resetElementAttributes(t, e) {
             this._applyManipulationCallback(t, t => {
                 ...
                 void 0 === n ? t.style.removeProperty(e) : (B.removeDataAttribute(t, e), t.style[e] = n)
             })
         }
     ...
     class Te {
         ...
         _getConfig(t) {
             return (t = { ...Ee,
                 ..."object" == typeof t ? t : {}
             }).rootElement = i(t.rootElement), a("backdrop", t, ke), t
         }
         _append() {
     ...
     class Me {
         ...
         activate() {
             ...
             this._isActive || (e && t.focus(), D.off(document, ".bs.focustrap"), D.on(document, "focusin.bs.focustrap", t => this._handleFocusin(t)), D.on(document, "keydown.tab.bs.focustrap", t => this._handleKeydown(t)), this._isActive = !0)
         }
         deactivate() {
     ...
     class Ie extends $ {
         constructor(t, e) {
             super(t), this._config = this._getConfig(e), this._dialog = F.findOne(".modal-dialog", this._element), this._backdrop = this._initializeBackDrop(), this._focustrap = this._initializeFocusTrap(), this._isShown = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._scrollBar = new xe
         }
         static get Default() {
             return Ae
         }
         ...
         hide() {
             ...
             t && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), this._focustrap.deactivate(), this._element.classList.remove("show"), D.off(this._element, "click.dismiss.bs.modal"), D.off(this._dialog, "mousedown.dismiss.bs.modal"), this._queueCallback(() => this._hideModal(), this._element, t)
         }
         dispose() {
             [window, this._dialog].forEach(t => D.off(t, ".bs.modal")), this._backdrop.dispose(), this._focustrap.deactivate(), super.dispose()
         }
         handleUpdate() {
             this._adjustDialog()
         }
         ...
         _triggerBackdropTransition() {
             ...
             !r && "hidden" === n.overflowY || t.contains("modal-static") || (r || (n.overflowY = "hidden"), t.add("modal-static"), this._queueCallback(() => {
                 t.remove("modal-static"), r || this._queueCallback(() => {
                     n.overflowY = ""
                 }, this._dialog)
         ...
         _adjustDialog() {
             const t = this._element.scrollHeight > document.documentElement.clientHeight,
                 ...
                 n = e > 0;
             (!n && t && !f() || n && !t && f()) && (this._element.style.paddingLeft = e + "px"), (n && !t && !f() || !n && t && f()) && (this._element.style.paddingRight = e + "px")
         }
         _resetAdjustments() {
     ...
     D.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', (function(t) {
         const e = n(this);
         ["A", "AREA"].includes(this.tagName) && t.preventDefault(), D.one(e, "show.bs.modal", t => {
     ...
     class Ve extends $ {
         ...
         show(t) {
             this._isShown || D.trigger(this._element, "show.bs.offcanvas", {
                 relatedTarget: t
             }).defaultPrevented || (this._isShown = !0, this._element.style.visibility = "visible", this._backdrop.show(), this._config.scroll || (new xe).hide(), this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.classList.add("show"), this._queueCallback(() => {
         ...
         hide() {
             this._isShown && (D.trigger(this._element, "hide.bs.offcanvas").defaultPrevented || (this._focustrap.deactivate(), this._element.blur(), this._isShown = !1, this._element.classList.remove("show"), this._backdrop.hide(), this._queueCallback(() => {
                 this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._element.style.visibility = "hidden", this._config.scroll || (new xe).reset(), D.trigger(this._element, "hidden.bs.offcanvas")
             }, this._element, !0)))
         }
         dispose() {
     ...
     D.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', (function(t) {
         ...
         r && r !== e && Ve.getInstance(r).hide(), Ve.getOrCreateInstance(e).toggle(this)
     })), D.on(window, "load.bs.offcanvas.data-api", () => F.find(".offcanvas.show").forEach(t => Ve.getOrCreateInstance(t).show())), N(Ve), m(Ve);
     const $e = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
         ...
         Re = (t, e) => {
             ...
             if (e.includes(n)) return !$e.has(n) || Boolean(Ne.test(t.nodeValue) || He.test(t.nodeValue));
     ...
     class Ge extends $ {
         ...
         show() {
             ...
             r.setAttribute("id", s), this._element.setAttribute("aria-describedby", s), this._config.animation && r.classList.add("fade");
             ...
             V.set(r, this.constructor.DATA_KEY, this), this._element.ownerDocument.documentElement.contains(this.tip) || (o.append(r), D.trigger(this._element, this.constructor.Event.INSERTED)), this._popper ? this._popper.update() : this._popper = de(this._element, r, this._getPopperConfig(a)), r.classList.add("show");
             ...
             this._queueCallback(() => {
                 ...
                 this._hoverState = null, D.trigger(this._element, this.constructor.Event.SHOWN), "out" === t && this._leave(null, this)
             }, this.tip, p)
         }
         hide() {
             ...
             t.classList.remove("show"), "ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach(t => D.off(t, "mouseover", u)), this._activeTrigger.click = !1, this._activeTrigger.focus = !1, this._activeTrigger.hover = !1;
             const e = this.tip.classList.contains("fade");
             this._queueCallback(() => {
                 this._isWithActiveTrigger() || ("show" !== this._hoverState && t.remove(), this._cleanTipClass(), this._element.removeAttribute("aria-describedby"), D.trigger(this._element, this.constructor.Event.HIDDEN), this._popper && (this._popper.destroy(), this._popper = null))
         ...
         setElementContent(t, e) {
             if (null !== t) return s(e) ? (e = i(e), void(this._config.html ? e.parentNode !== t && (t.innerHTML = "", t.append(e)) : t.textContent = e.textContent)) : void(this._config.html ? (this._config.sanitize && (e = ze(e, this._config.allowList, this._config.sanitizeFn)), t.innerHTML = e) : t.textContent = e)
         }
         getTitle() {
         ...
         _setListeners() {
             this._config.trigger.split(" ").forEach(t => {
                 if ("click" === t) D.on(this._element, this.constructor.Event.CLICK, this._config.selector, t => this.toggle(t));
                 else if ("manual" !== t) {
                     const e = "hover" === t ? this.constructor.Event.MOUSEENTER : this.constructor.Event.FOCUSIN,
                         n = "hover" === t ? this.constructor.Event.MOUSELEAVE : this.constructor.Event.FOCUSOUT;
                     D.on(this._element, e, this._config.selector, t => this._enter(t)), D.on(this._element, n, this._config.selector, t => this._leave(t))
                 }
         ...
         _getConfig(t) {
             ...
             return Object.keys(e).forEach(t => {
                 ...
                 ...e,
                 ..."object" == typeof t && t ? t : {}
             }).container = !1 === t.container ? document.body : i(t.container), "number" == typeof t.delay && (t.delay = {
                 show: t.delay,
                 hide: t.delay
             }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), a("tooltip", t, this.constructor.DefaultType), t.sanitize && (t.template = ze(t.template, t.allowList, t.sanitizeFn)), t
         }
         _getDelegateConfig() {
             const t = {};
     ...
     class en extends $ {
         constructor(t, e) {
             super(t), this._scrollElement = "BODY" === this._element.tagName ? window : this._element, this._config = this._getConfig(e), this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, D.on(this._scrollElement, "scroll.bs.scrollspy", () => this._process()), this.refresh(), this._process()
         }
         static get Default() {
             return Je
         }
         ...
         refresh() {
             ...
             this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), F.find(tn, this._config.target).map(t => {
                 const s = e(t),
                     i = s ? F.findOne(s) : null;
                 if (i) {
                     const t = i.getBoundingClientRect();
                     if (t.width || t.height) return [B[n](i).top + r, s]
                 }
                 return null
         ...
         _getConfig(t) {
             return (t = { ...Je,
                 ...B.getDataAttributes(this._element),
                 ..."object" == typeof t && t ? t : {}
             }).target = i(t.target) || document.documentElement, a("scrollspy", t, Ze), t
         }
         _getScrollTop() {
         ...
         _activate(t) {
             ...
             n.classList.add("active"), n.classList.contains("dropdown-item") ? F.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add("active") : F.parents(n, ".nav, .list-group").forEach(t => {
     ...
     class nn extends $ {
         ...
         _transitionComplete(t, e, n) {
             ...
             if (r && "LI" === r.nodeName && (r = r.parentNode), r && r.classList.contains("dropdown-menu")) {
                 ...
                 e && F.find(".dropdown-toggle", e).forEach(t => t.classList.add("active")), t.setAttribute("aria-expanded", !0)
             }
             n && n()
         }
         static jQueryInterface(t) {
     ...
     D.on(document, "click.bs.tab.data-api", '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', (function(t) {
         ["A", "AREA"].includes(this.tagName) && t.preventDefault(), l(this) || nn.getOrCreateInstance(this).show()
     })), m(nn);
     const rn = {
             animation: "boolean",
             autohide: "boolean",
 ...
 function(t, e) {
     ...
     function T(t) {
         ...
         if (e.allowClick && (e.updateClickedSlide(l), e.emit("tap click", l), u < 300 && c - n.lastClickTime < 300 && e.emit("doubleTap doubleClick", l)), n.lastClickTime = d(), p(() => {
     ...
     const $ = {
             ...
             update: {
                 ...
                 updateSlidesProgress: function(t = this && this.translate || 0) {
                     ...
                     let i = -t;
                     s && (i = t), r.removeClass(n.slideVisibleClass), e.visibleSlidesIndexes = [], e.visibleSlides = [];
                     for (let t = 0; t < r.length; t += 1) {
                         ...
                         (c >= 0 && c < e.size - 1 || u > 1 && u <= e.size || c <= 0 && u >= e.size) && (e.visibleSlides.push(a), e.visibleSlidesIndexes.push(t), r.eq(t).addClass(n.slideVisibleClass)), a.progress = s ? -l : l
                     }
             ...
             slide: {
                 ...
                 slidePrev: function(t = this.params.speed, e = !0, n) {
                     ...
                     let f = 0;
                     return void 0 !== h && (f = o.indexOf(h), f < 0 && (f = r.activeIndex - 1), "auto" === s.slidesPerView && 1 === s.slidesPerGroup && s.slidesPerGroupAuto && (f = f - r.slidesPerViewDynamic("previous", !0) + 1, f = Math.max(f, 0))), r.slideTo(f, t, e, n)
                 },
             ...
             loop: {
                 loopCreate: function() {
                     ...
                     i.each((e, n) => {
                         const r = c(e);
                         n < t.loopedSlides && o.push(e), n < i.length && n >= i.length - t.loopedSlides && a.push(e), r.attr("data-swiper-slide-index", n)
                     });
                     for (let t = 0; t < o.length; t += 1) s.append(c(o[t].cloneNode(!0)).addClass(n.slideDuplicateClass));
                     for (let t = a.length - 1; t >= 0; t -= 1) s.prepend(c(a[t].cloneNode(!0)).addClass(n.slideDuplicateClass))
                 },
                 loopFix: function() {
                     const t = this;
     ...
     const Q = [function({
         ...
         n("beforeInit", () => {
             ...
             t.params.a11y.enabled && (function() {
                 ...
                 }), t.navigation && t.navigation.$nextEl && (f = t.navigation.$nextEl), t.navigation && t.navigation.$prevEl && (v = t.navigation.$prevEl), f && f.length && g(f, i, e.nextSlideMessage), v && v.length && g(v, i, e.prevSlideMessage), m() && t.pagination.$el.on("keydown", z(t.params.pagination.bulletClass), h)
             }(), f())
         }), n("toEdge", () => {
             ...
             t.params.a11y.enabled && function() {
                 ...
                 m() && t.pagination.bullets.each(n => {
                     const r = c(n);
                     i(r), t.params.pagination.renderBullet || (o(r, "button"), u(r, e.paginationBulletMessage.replace(/\{\{index\}\}/, r.index() + 1)))
                 })
             }()
         }), n("destroy", () => {
             t.params.a11y.enabled && function() {
                 let e, n;
                 r && r.length > 0 && r.remove(), t.navigation && t.navigation.$nextEl && (e = t.navigation.$nextEl), t.navigation && t.navigation.$prevEl && (n = t.navigation.$prevEl), e && e.off("keydown", h), n && n.off("keydown", h), m() && t.pagination.$el.off("keydown", z(t.params.pagination.bulletClass), h)
             }()
         })
     }, function({
         swiper: t,
         ...
         G({
             ...
             setTranslate: () => {
                 ...
                 for (let i = 0; i < e.length; i += 1) {
                     ...
                     l < 0 ? (h = n.next, d = !0) : l > 0 && (h = n.prev, d = !0), u.forEach((t, e) => {
                     ...
                     if (d && h.shadow || !d) {
                         ...
                         if (0 === t.length && h.shadow && (t = K(n, a)), t.length) {
     ...
     return function(t) {
         ...
         function it() {
             for (var t = document.getElementsByTagName("a"), e = function(e) {
                     ...
                     var s;
                     s = "#" === r.charAt(0) ? document.getElementById(r.substring(1)) : r, fsLightboxInstances[n].props.sources.push(s), fsLightboxInstances[n].elements.a.push(t[e]);
